...
public class DialogFilterType extends JDialog {
    ...
    public DialogFilterType (MyPresenter myPresenter) {
    ...
    public void initComponents(MyPresenter myPresenter){
        ...
        comboTypeProduct = new JComboBox<>(TypeProduct.values());
        comboTypeProduct.setBorder(BorderFactory.createTitledBorder("Tipo de producto"));
        ...
        this.jCloseButton.setActionCommand(Commands.C_CLOSE_DIALOG_TYPE.toString());
        this.jCloseButton.addActionListener(myPresenter);

        this.panelConainter.add(jScrollPane);
        this.panelConainter.add(comboTypeProduct);
    ...
    public String returnChosenType(){
        return String.valueOf(comboTypeProduct.getSelectedItem());
    }
}
