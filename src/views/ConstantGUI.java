...
public class ConstantGUI {
    ...
    public static final String ICON_DELETE_PRODUCT = "/images/minus.png";
    ...
    public static final String T_ADD_PRODUCT = "Add_Product" ;
    public static final String T_MAIN_WINDOW ="Anivet" ;
    public static final String T_LIST_PRODUCTS= "Show_products";
